    ...
    <section id="skills" className="py-20 px-4 sm:px-8 md:px-16 lg:px-24 bg-gray-100">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6" ref={sectionRef}>
        <div className="bg-white border border-gray-200 rounded-2xl p-7 shadow-sm skill-card">
          ...
          <div className="mb-4"><div className="flex justify-between text-sm text-gray-700 mb-1.5"><span>HTML/CSS</span><span className="text-gray-500 text-xs">90%</span></div><div className="h-1.5 rounded-full bg-[#e5e9f5] overflow-hidden"><div className="skill-bar-fill h-full rounded-full bg-gradient-to-r from-blue-600 to-blue-400 transition-all duration-1000" style={{width:0}} data-width="90"></div></div></div>
          <div className="mb-4"><div className="flex justify-between text-sm text-gray-700 mb-1.5"><span>React.js</span><span className="text-gray-500 text-xs">60%</span></div><div className="h-1.5 rounded-full bg-[#e5e9f5] overflow-hidden"><div className="skill-bar-fill h-full rounded-full bg-gradient-to-r from-blue-600 to-blue-400 transition-all duration-1000" style={{width:0}} data-width="60"></div></div></div>
          ...
          <div className="mb-4"><div className="flex justify-between text-sm text-gray-700 mb-1.5"><span>JavaScript</span><span className="text-gray-500 text-xs">85%</span></div><div className="h-1.5 rounded-full bg-[#e5e9f5] overflow-hidden"><div className="skill-bar-fill h-full rounded-full bg-gradient-to-r from-blue-600 to-blue-400 transition-all duration-1000" style={{width:0}} data-width="85"></div></div></div>
          <div><div className="flex justify-between text-sm text-gray-70₀" style={{width: 85}} data-width="85"></ div ></ div ></ div >
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-7 shadow-sm skill-card">
          ...
          <div className="mb-4"><div className="flex justify-between text-sm text-gray-700 mb-1.5"><span>flask</span><span className="text-gray-500 text-xs">75%</span></div><div className="h-1.5 rounded-full bg-[#e5e9f5] overflow-hidden"><div className="skill-bar-fill h-full rounded-full bg-gradient-to-r from-blue-600 to-blue-400 transition-all duration-1000" style={{width:0}} data-width="75"></div></div></div>
          ...
          <div><div className="flex justify-between text-sm text-gray-700 mb-1.5"><span>Nextjs</span><span className="text-gray-500 text-xs">70%</span></div><div className="h-1.5 rounded-full bg-[#e5e9f5] overflow-hidden"><div className="skill-bar-fill h-full rounded-full bg-gradient-to-r from-blue-600 to-blue-400 transition-all duration-1000" style={{width:0}} data-width="70"></div></div></div>
        </div>
